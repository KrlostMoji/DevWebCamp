<main class="auth">
    ...
    <form class="formulario" method="POST" action="/registro">
        ...
        <div class="formulario__campo">
            ...
            <input type="password" class="formulario__input" placeholder="Confirma password" id="password2" name="password2">
        </div>
    ...
    <div class="acciones">
        ...
        <a href="/olvide" class="acciones__enlace">
            Recuperar tu password
        </a>
    </div>
