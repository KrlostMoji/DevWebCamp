        ...
        <?php foreach($ponentes as $ponente){ ?>
            <div <?php aos_animacion(); ?> class="speaker">
                <picture>
                    ...
                    <img class="speaker__imagen" loading="lazy" width="200" height="300" src="" alt="<?php echo $_ENV['HOST'] . '/build/img/speakers/' . $evento->ponente->imagen; ?>.png" alt="Imagen Ponente">
...
<section class="boletos">
    ...
    <div <?php aos_animacion(); ?> class="boletos__grid">
        <div class="boleto boleto--presencial">
            ...
            <p class="boleto__precio">$199.00</p>
